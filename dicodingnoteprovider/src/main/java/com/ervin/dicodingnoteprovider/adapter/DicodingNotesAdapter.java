package com.ervin.dicodingnoteprovider.adapter;
...
import com.ervin.dicodingnoteprovider.R;

import static com.ervin.dicodingnoteprovider.DatabaseContract.NoteColumns.DATE;
import static com.ervin.dicodingnoteprovider.DatabaseContract.NoteColumns.DESCRIPTION;
import static com.ervin.dicodingnoteprovider.DatabaseContract.NoteColumns.TITLE;
...
public class DicodingNotesAdapter extends CursorAdapter {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_dicocing_note, viewGroup, false);
        return view;
    }
